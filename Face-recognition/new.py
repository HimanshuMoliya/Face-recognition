...
# You can add any imange manually by typing two line

mk_image = face_recognition.load_image_file("mk.jpg")
mk_face_encoding = face_recognition.face_encodings(mk_image)[0]

# you can increase your dataset by adding image in face-recognition folder
#patel_image = face_recognition.load_image_file("patel.jpg")
#patel_face_encoding = face_recognition.face_encodings(patel_image)[0]
...
# This names will have shown in your camera screen
known_face_names = [
    #"patel",
    "Gandhiji"
]
